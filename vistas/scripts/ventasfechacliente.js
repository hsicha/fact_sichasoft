...
function descargar_PDF(ruc, cod_document, serie, numero){
	...
	console.log(name_file);
	 var fileUrl = 'http://www.demo.sichasoft.com/api/API_SUNAT/files/facturacion_electronica/PDF/'+name_file; // Cambia esto por la URL del archivo que deseas descargar
                $.ajax({
